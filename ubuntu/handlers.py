...
async def register_user(message: types.Message):
    ...
    admin_markup = InlineKeyboardMarkup(
        ...
        [
            [
                InlineKeyboardButton(text="Добваить товар", callback_data="add_item")],
            [
                ...
                InlineKeyboardButton(text="Список товаров", callback_data="categories")
            ]
        ]
    )
...
@dp.callback_query_handler(text_contains="categories")
...
async def show_items(message: Message):
    ...
    for num, accessories in enumerate(all_items):
        ...
        markup = InlineKeyboardMarkup(
            ...
            [
                [
                    ...
                    InlineKeyboardButton(text=("Купить"), callback_data=buy_item.new(item_id=accessories.accesories_id))
                ],
            ]
        )
        ...
        await message.answer_photo(
            photo=accessories.acessories_photo,
            caption=text.format(
                id=accessories.accesories_id,
                name=accessories.accesories_name,
                price=accessories.accesspries_price
            ),
            reply_markup=markup
        )
